<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="选项a" prop="xuanxianga">
          <el-input v-model="ruleForm.xuanxianga" 
              placeholder="选项a" clearable  :readonly="ro.xuanxianga"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="选项a" prop="xuanxianga">
              <el-input v-model="ruleForm.xuanxianga" 
                placeholder="选项a" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="选项b" prop="xuanxiangb">
          <el-input v-model="ruleForm.xuanxiangb" 
              placeholder="选项b" clearable  :readonly="ro.xuanxiangb"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="选项b" prop="xuanxiangb">
              <el-input v-model="ruleForm.xuanxiangb" 
                placeholder="选项b" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="选项c" prop="xuanxiangc">
          <el-input v-model="ruleForm.xuanxiangc" 
              placeholder="选项c" clearable  :readonly="ro.xuanxiangc"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="选项c" prop="xuanxiangc">
              <el-input v-model="ruleForm.xuanxiangc" 
                placeholder="选项c" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="选项d" prop="xuanxiangd">
          <el-input v-model="ruleForm.xuanxiangd" 
              placeholder="选项d" clearable  :readonly="ro.xuanxiangd"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="选项d" prop="xuanxiangd">
              <el-input v-model="ruleForm.xuanxiangd" 
                placeholder="选项d" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.toupiaoneirong = this.ruleForm.toupiaoneirong.replace(reg,'../../../php0uga6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `toupiaoxiangmu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.toupiaoxiangmuCrossAddOrUpdateFlag = false;
						 this.parent.search();
