  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
		...
		<el-form-item class="select" label="活动分类" prop="huodongfenlei">
		  <el-select  @change="huodongfenleiChange" clearable v-model="searchForm.huodongfenlei" placeholder="请选择活动分类">
		    <el-option
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign" 
               :header-align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('shetuanhuodong','报名') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="baomingxinxiCrossAddOrUpdateHandler(scope.row,'cross','','[1]','已报名')">{{ contents.tableBtnFont == 1?'报名':'' }}</el-button>
                <el-button v-if="isAuth('shetuanhuodong','报名') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="baomingxinxiCrossAddOrUpdateHandler(scope.row,'cross','','[1]','已报名')">{{ contents.tableBtnFont == 1?'报名':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('shetuanhuodong','报名') && contents.tableBtnIcon == 0" type="success" size="mini" @click="baomingxinxiCrossAddOrUpdateHandler(scope.row,'cross','','[1]','已报名')">{{ contents.tableBtnFont == 1?'报名':'' }}</el-button>
